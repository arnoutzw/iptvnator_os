...
- TV mode: launch at login and start in fullscreen (Settings > General) for dedicated TV setups 📺 _(desktop; login item on macOS & Windows)_ — see the [TV Mode setup guide](docs/tv-mode-setup.md)
